...
function LoginForm() {
  ...
  return (
    <div className="relative w-full">
      <form onSubmit={handleSubmit} className="space-y-5 w-full max-w-sm mx-auto">
        ...
        <div className="flex justify-center gap-3">
          {[FaGoogle, FaFacebookF, FaGithub, FaLinkedinIn].map((Icon, i) => (
            <button key={i} type="button" className="w-10 h-10 flex items-center justify-center bg-white border rounded-full shadow hover:scale-105 transition">
      ...
      {/* Modal inside right panel */}
      {showForgot && (
        <div className="absolute inset-0 bg-white bg-opacity-95 flex items-center justify-center p-6">
          <div className="bg-white rounded-lg p-6 w-full max-w-sm space-y-4 shadow-lg border">
...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-100 to-purple-200 font-sans">
      <div className="bg-white rounded-none shadow-none flex w-full h-screen overflow-hidden relative">
        <div className="w-1/2 p-8 flex items-center justify-center relative z-10">
          <div className={`absolute inset-0 flex items-center justify-center transition-opacity duration-500 ${!isLogin ? 'opacity-100 z-10' : 'opacity-0 z-0 pointer-events-none'}`}>
        ...
        <div className={`absolute top-0 h-full w-1/2 bg-blue-500 text-white flex flex-col justify-center items-center p-12 transition-all duration-700 ease-in-out z-20 ${isLogin ? 'left-0' : 'left-1/2'}`}
          style={{ borderRadius: isLogin ? '0 150px 150px 0' : '150px 0 0 150px' }}
        >
          ...
          <button
            ...
            className="bg-transparent border-2 border-white px-6 py-2 rounded-full hover:bg-white hover:text-blue-500 transition duration-300 transform hover:scale-105"
          >
